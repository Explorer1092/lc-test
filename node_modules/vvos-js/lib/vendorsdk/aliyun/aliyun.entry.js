...
// import async from 'async/dist/async.min.js';
...
var aliyun = function () {
  ...
  _createClass(aliyun, [{
    ...
    key: '__UploadPart',
    value: function __UploadPart(file, callback) {
      var request = new XMLHttpRequest(); // 新建XMLHttpRequest对象
      // 发送请求:
    ...
    value: function sliceUpFile(file, callback, process) {
      ...
      (0, _waterfall2.default)([function (callback) {
        ...
        (0, _mapLimit2.default)(chunks, 1, function (chunk, callback) {
          typeof process == 'function' && process(null, { file: file, chunk: chunk });
          _this.__UploadPart(chunk, callback);
        }, function (err, data) {
